...
<head>
    ...
    <style>
        ...
        .message-box { background: #f8f9fa; border: 2px solid #e9ecef; border-radius: 10px; padding: 20px; margin: 30px 0; }
        .message-box h3 { margin: 0 0 10px 0; color: #14a800; font-size: 1.1rem; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have received a new message from <strong>{{ $message->sender->name }}</strong> in your exchange.</p>
            <div class="message-box">
                <h3>Message Preview</h3>
                <p>{{ Str::limit($message->message, 200) }}</p>
            </div>
            <a href="{{ $actionUrl }}" class="btn">View Message</a>
